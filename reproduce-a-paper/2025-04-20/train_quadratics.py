...
train_generator = QuadraticsGenerator(initializer, Params.BATCH_SIZE, Params.STEPS_PER_EPOCH)
val_generator = QuadraticsGenerator(initializer, Params.BATCH_SIZE, Params.STEPS_PER_EPOCH)
...
if __name__ == '__main__':
    ...
    model = GlobalOptimizer(
            optimizee=QuadraticsFunction(initializer=initializer)
        )
    ...
    model.save_weights('quadratics_model.weights.h5')
